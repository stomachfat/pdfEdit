...
var _LandingPage = __webpack_require__(33);

var _LandingPage2 = _interopRequireDefault(_LandingPage);

var _LoadingPage = __webpack_require__(43);

var _LoadingPage2 = _interopRequireDefault(_LoadingPage);

var _Paywall = __webpack_require__(44);
...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        value: function moveToNextPage() {
            var pageTransitions = [[_LandingPage2.default, _LoadingPage2.default], [_LoadingPage2.default, _Paywall2.default]];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_styles__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_attr_accept__ = __webpack_require__(39);
...
// module
exports.push([module.i, ".dropFileText {\n  margin: 30% 0;\n}\n", ""]);
...
var LoadingPage = function (_Component) {
    _inherits(LoadingPage, _Component);

    function LoadingPage(props) {
        _classCallCheck(this, LoadingPage);

        var _this = _possibleConstructorReturn(this, (LoadingPage.__proto__ || Object.getPrototypeOf(LoadingPage)).call(this, props));

        _this.state = {
            progress: 0
        };
        _this.loadingProgress = _this.loadingProgress;
        return _this;
    }
    ...
    _createClass(LoadingPage, [{
        ...
        value: function loadingProgress() {
            ...
            setTimeout(function () {
                _this2.setState({
                    progress: Math.min(_this2.state.progress + Math.floor(Math.random() * 10), 100)
                });
                _this2.loadingProgress();
...
var Paywall = function Paywall() {
    return _react2.default.createElement(
        'div',
        null,
        'Your Microsoft word document is now ready to download for $0.99'
    );
};
